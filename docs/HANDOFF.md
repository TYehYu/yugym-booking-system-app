...
Sprint 2/3 已上線穩定運作；7/17 完成首頁改版（Dashboard V2）；7/18 修掉行事曆點空格競態、
推進票券 V4（落差 1 方案複製、落差 2 方案封存三態）、並啟動 Inline Expand Card 行事曆改版
（階段 0 週曆7天、1 卡片標準化、2 Hover Fish-eye、3a 點卡原地展開+簽到/取消、3b 卡內直接編輯）。
**線上版本 `260718.1042`**。今日詳情見 §1.4。

...
const GONE=[
  ...
  'mc-card-more', 'mc-duty-av', 'mc-duty-b', 'mc-duty-badge',
  'mc-duty-card', 'mc-duty-item', 'mc-duty-list', 'mc-duty-nm',
  'mc-duty-tm', 'mc-greet-hi', 'mc-greet-sub', 'mc-grid-bottom',
  'mc-grid-bottom-solo', 'mc-grid2', 'mc-grid3', 'mc-hero',
  'mc-hero-art', 'mc-hero-bigclock', 'mc-hero-block', 'mc-hero-danger',
  'mc-hero-date', 'mc-hero-hello', 'mc-hero-hi', 'mc-hero-meta',
  'mc-hero-nobg', 'mc-hero-ok', 'mc-hero-row', 'mc-hero-slim',
  'mc-hero-status', 'mc-hero-sub', 'mc-hero-summary', 'mc-hero-toolbar',
  'mc-hero-tools', 'mc-hero-warn', 'mc-hero2-l', 'mc-hero2-r',
  'mc-hm-b', 'mc-hm-ic', 'mc-hm-item', 'mc-hm-lbl',
  'mc-hm-sep', 'mc-htool', 'mc-k2', 'mc-k2-row',
  'mc-kpi', 'mc-kpi-b', 'mc-kpi-brk', 'mc-kpi-card',
  'mc-kpi-ic', 'mc-kpi-l', 'mc-kpi-money', 'mc-kpi-s',
  'mc-kpi-u', 'mc-kpis', 'mc-kpis-3', 'mc-kpis-5',
  'mc-kpis-cards', 'mc-main-left', 'mc-main-right', 'mc-main-row',
  'mc-msb', 'mc-msb-sel', 'mc-og-ic', 'mc-ops-growth',
  'mc-ops-i', 'mc-ops-ic', 'mc-ops-l', 'mc-ops-money',
  'mc-ops-n', 'mc-ops-nums', 'mc-ops-nums-3', 'mc-ops-s',
  'mc-qtool', 'mc-quick-card', 'mc-quick-tools', 'mc-quick-tools-4',
  'mc-quick-tools-6', 'mc-remind-all', 'mc-remind-card', 'mc-sb-ic',

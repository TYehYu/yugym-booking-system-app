...
/* 2026-09-05：守門原本只長在「待審核發放」清單上，而清單只保護清單自己。
   清單移除時發現收款審核／儲存／發放／取消四支從來沒檢查過 —— 一起補上。 */
t('★★ 收款審核那條路四支都有守門', ['僅管理員／櫃台可審核','僅管理員／櫃台可發放票券',
  '僅管理員／櫃台可修改收款資訊','僅管理員／櫃台可取消'].every(m=>src.includes(m)));

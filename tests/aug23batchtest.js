...
/* 2026-09-03：場地改名「史密斯訓練架」，課卡改用縮寫「訓練架」（三個字 ≒ 33px），
   這一欄比當初寬鬆很多；當時的換算保留在註解裡當由來。 */
ok('★★ 收窄的底線寫進註解：中欄當時要留 ~76px，再窄就先切到場地那一列',
   /當時最寬的一列是場地「多功能訓練架」六個字 ×11px ≒ 66px，剛好不截斷/.test(src)
   && /場地那一列 2026-09-03 起是縮寫「訓練架」三個字 ≒ 33px/.test(src)
